<?php
namespace Swissup\Easybanner\Ui\Component\Listing\Column;
                ...
                if (isset($item['banner_id'])) {
                    $item[$this->getData('name')] = [
                        ...
                        'enable' => [
                            ...
                            'label' => __('Enable'),
                            'confirm' => [
                                'title' => __('Enable "${ $.$data.identifier }"'),
                                'message' => __('Are you sure you wan\'t to enable a "${ $.$data.identifier }" record?')
                            ]
                        ],
                        'disable' => [
                            'href' => $this->urlBuilder->getUrl(
                            ...
                            'label' => __('Disable'),
                            'confirm' => [
                                'title' => __('Disable "${ $.$data.identifier }"'),
                                'message' => __('Are you sure you wan\'t to disable a "${ $.$data.identifier }" record?')
                            ]
                        ]
                    ];
                }
