...
Easybanner.Timer = function() {
    ...
    // });
    $(document).on('mousemove', $.proxy(this, 'inactivity'));
    $(document).on('click', $.proxy(this, 'inactivity'));
    $(document).on('scroll', $.proxy(this, 'inactivity'));
    $(document).on('keyup', $.proxy(this, 'inactivity'));
