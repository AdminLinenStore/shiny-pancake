...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl('easybanner/banner/chooser', ['uniq_id' => $uniqId]);
        ...
        if ($element->getValue()) {
            ...
            if ($page->getId()) {
                $chooser->setLabel($this->escapeHtml($page->getIdentifier()));
            }
        }
    ...
    {
        return $this->getUrl('easybanner/banner/chooser', ['_current' => true]);
    }
}
