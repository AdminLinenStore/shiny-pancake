...
class Customer extends \Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Related
{
    ...
    public function getSelectedRelatedProducts()
    {
        ...
        $relatedCustomerItems = $customerModel->getRelatedProductData($productId);
        $products = [];
        foreach ($relatedCustomerItems as $item) {
