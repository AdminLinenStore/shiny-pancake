...
class SaveOptionRelationObserver implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $productOptions = $this->optionConverter->getOptionsAsArray($this->resetOption($product));
        ...
        foreach ($collection as $group) {
            $groupOptionsIds = array_keys($this->optionConverter->getOptionsAsArray($group));
            if (in_array($group->getId(), $newGroupIds)) {
                 ...
                 */
            } else if (in_array($group->getId(), $delGroupIds)) {
